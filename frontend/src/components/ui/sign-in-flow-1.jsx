...
export const SignInPage = ({ className, onSubmit, error, loading }) => {
  ...
  const handlePasswordSubmit = async (e) => {
    ...
    if (password) {
      ...
      // Trigger the parent login function
      const success = await onSubmit(email, password);
      if (success) {
        setStep("success");
      } else {
        // Reset canvas reverse animation if login failed
              ...
              <AnimatePresence mode="wait">
                {step === "email" ? (
                  ...
                  >
                    ...
                    {error && (
                      <div className="text-red-500 text-xs bg-red-950/40 border border-red-900/30 p-2.5 rounded-full">
                        {error}
                      </div>
                    )}
                  ...
                  >
                    <div className="space-y-1">
                      ...
                      <p className="text-[1.25rem] text-white/50 font-light">to authenticate account</p>
                    </div>
                    ...
                    <form onSubmit={handlePasswordSubmit} className="space-y-4">
                      ...
                      <div className="flex w-full gap-3">
                        ...
                        <motion.button 
                          type="submit"
                          className="flex-1 rounded-full font-medium py-3 border bg-white text-black border-transparent hover:bg-white/90 cursor-pointer"
                          whileHover={{ scale: 1.02 }}
                          whileTap={{ scale: 0.98 }}
                          disabled={loading}
                        >
                  ...
                  >
                    <div className="space-y-1">
                      ...
                      <p className="text-[1.25rem] text-white/50 font-light">Welcome to Crownridge Systems</p>
                    </div>
